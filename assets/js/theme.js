			...
			.on('click', function() {
				...
				var tl_olMenuClick = gsap.timeline();
					 ...
					 setTimeout(function () {
						...
						gsap.set("#content-wrap", { autoAlpha: 1 });				
   ...
   // ============================================================================
	...
	ScrollTrigger.matchMedia({
		"(min-width: 768px)": function() {
			$(".tt-grid.ttgr-layout-creative-1 .tt-grid-item:nth-of-type(6n+2), .tt-grid.ttgr-layout-creative-1 .tt-grid-item:nth-of-type(6n+4), .tt-grid.ttgr-layout-creative-2 .tt-grid-item:nth-of-type(4n+2), .tt-grid.ttgr-layout-creative-2 .tt-grid-item:nth-of-type(4n+3)").each(function() {
				var $this = $(this);
	...
	// 划线效果-原文字下滑
	$(".anim-lineout").each(function() {
		let tl_lineout = gsap.timeline({
			scrollTrigger: {
				trigger: this,
				start: "top 55%",
				markers: false
		...
		tl_lineout.to(this, { duration: 1, opacity: 0.5,scale: 0.4, y: 0 }, "+=0.3")
	});

	// svg划线效果
	$(".anim-drawline").each(function() {
		let tl_drawline = gsap.timeline({
			scrollTrigger: {
				trigger: this,
				start: "top 55%",
				markers: false
		...
		// t1_drawline.delay(3)
		tl_drawline.add(createLineTween(this))
		function createLineTween(svg) { 
			var pathObject = {length:0, pathLength:svg.getTotalLength()}; 
			var tween = TweenLite.to(pathObject, 2, {delay:1,length:pathObject.pathLength, onUpdate:drawLine, onUpdateParams:[pathObject, svg], immediateRender:true});
			return tween;
		 };
	...
	// 划线效果-新文字下滑
	$(".anim-linenew").each(function() {
		let tl_linenew = gsap.timeline({
			scrollTrigger: {
				trigger: this,
				start: "top 75%",
				markers: false
		...
		tl_linenew.from(this, { duration: 1,delay:1, opacity: 0, y: 100 }, "+=0.3")
	});
